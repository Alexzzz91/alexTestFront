(function (global, factory) {
  ...
  (global.HyperList = factory(global.React));
...
var React$$1 = (typeof global !== 'undefined' ? global : window).React || function () {
  try {
...
var HyperList = function () {
  ...
  _createClass(HyperList, [{
    ...
    value: function _renderChunk(force) {
      ...
      // to the parent node
      var fragment = config.useFragment ? document.createDocumentFragment() : [];var scroller = this._scroller;
...
var _class = function (_Component) {
  ...
  _createClass(_class, [{
    ...
    value: function render() {
      ...
      var _props$component = this.props.component,
          Component$$1 = _props$component === undefined ? 'div' : _props$component;
      var _state = this.state,
          element = _state.element,
          scroller = _state.scroller,
      ...
      return React__default.createElement(
        ...
        { ref: function ref(node) {
            return _this2.wrapperNode = node;
          }, style: element.style },
        React__default.createElement(Component$$1, scroller),
        fragment
      );
    }
  }]);
  ...
  function _class(props) {
    ...
    _this.state = { element: {}, scroller: {}, fragment: [], config: config };
    return _this;
  }
  ...
  _createClass(_class, [{
    ...
    value: function componentDidMount() {
      ...
      var isHoriz = horizontal;

      var _props2 = this.props,
          _props2$width = _props2.width,
          width = _props2$width === undefined ? this.state.config.width : _props2$width,
          _props2$height = _props2.height,
          height = _props2$height === undefined ? this.state.config.height : _props2$height,
          itemHeight = _props2.itemHeight,
          total = _props2.total,
          reverse = _props2.reverse,
          _props2$generate = _props2.generate,
          generate = _props2$generate === undefined ? typeof children === 'function' ? children : null : _props2$generate,
          _props2$overrideScrol = _props2.overrideScrollPosition,
          overrideScrollPosition = _props2$overrideScrol === undefined ? function () {
        return _this3.wrapperNode[scrollProp];
      } : _props2$overrideScrol;


      var scrollProp = isHoriz ? 'scrollLeft' : 'scrollTop';
      ...
      var config = Object.assign({}, this.state.config, {
        ...
        applyPatch: function applyPatch(element, fragment, scroller) {
          var scrollProp = isHoriz ? 'scrollLeft' : 'scrollTop';
          ...
          _this3.setState({ element: element, fragment: fragment, scroller: scroller });
        }
      });
